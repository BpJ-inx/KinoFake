<template >
    <div class="aboutFilm h-auto hidden" v-for="film in responseMove" :key="film.id">
        ...
        <div class="imgSide ">
            ...
            <!-- <div class="fav__star" v-if="isFav">
            ...
            <button class="buttonFav cursor-pointer" v-if="isAutho" @click="addFavoriteFilm">To favorites</button>
...
import { addFavoriteFilm, checkIsFav, isFav } from '../hooks/addFavorite.js'
